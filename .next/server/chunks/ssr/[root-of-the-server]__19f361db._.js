...
"[project]/src/lib/context/GlobalContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GlobalProvider({ children }) {
    ...
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Add this
        ...
        try {
            ...
            if (user) {
                ...
                setUser({
                    ...
                    // Investor fields
                    notification_settings: profile?.notification_settings ? profile.notification_settings : {
                        offers_tips: false,
                        news: true,
                        status_changes: true
                    },
                    search_preferences: profile?.preferences || {}
                });
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19f361db._.js.map