...
"[project]/src/config/map_configuration.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$map_configuration$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/map_configuration.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
const SpecializedMap = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(_c = _s((param, ref)=>{
    let { mapType, activeLayers, className = "", attribution = '© OpenStreetMap contributors' } = param;
    var _MAP_CONFIGURATIONS_mapType;
    _s();
    ...
    const addedLayersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Set());
    // Sammle alle Layer aus activeLayers oder fallback auf mapType
    const layersToShow = activeLayers ? activeLayers.flatMap((key)=>{
        var _MAP_CONFIGURATIONS_key;
        return ((_MAP_CONFIGURATIONS_key = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$map_configuration$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIGURATIONS"][key]) === null || _MAP_CONFIGURATIONS_key === void 0 ? void 0 : _MAP_CONFIGURATIONS_key.layers) || [];
    }) : ((_MAP_CONFIGURATIONS_mapType = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$map_configuration$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIGURATIONS"][mapType]) === null || _MAP_CONFIGURATIONS_mapType === void 0 ? void 0 : _MAP_CONFIGURATIONS_mapType.layers) || [];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SpecializedMap.useEffect": ()=>{
            ...
            const addLayers = {
                "SpecializedMap.useEffect.addLayers": ()=>{
                    ...
                    addedLayersRef.current.forEach({
                        "SpecializedMap.useEffect.addLayers": (layerId)=>{
                            const stillActive = layersToShow.some({
                                "SpecializedMap.useEffect.addLayers.stillActive": (l)=>l.id === layerId
                            }["SpecializedMap.useEffect.addLayers.stillActive"]);
                            if (!stillActive) {
                                var _mapRef_current;
                                (_mapRef_current = mapRef.current) === null || _mapRef_current === void 0 ? void 0 : _mapRef_current.removeRasterLayer(layerId);
                                addedLayersRef.current.delete(layerId);
                            }
                        }
                    }["SpecializedMap.useEffect.addLayers"]);
                    // Füge neue Layer hinzu
                    layersToShow.forEach({
            ...
            return ({
                "SpecializedMap.useEffect": ()=>clearTimeout(timeout)
            })["SpecializedMap.useEffect"];
        }
    }["SpecializedMap.useEffect"], [
        layersToShow,
...
}, "NxcEVWZl3phZg7q3ic6wny3D13Y=")), "NxcEVWZl3phZg7q3ic6wny3D13Y=");
_c1 = SpecializedMap;
...
function DashboardContent() {
    ...
    const [selectedLayers, setSelectedLayers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        'flood'
    ]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        className: "space-y-3",
                        children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$map_configuration$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIGURATIONS"]).map((param)=>{
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        ...
                                        children: [
                                            ...
                                            config.color && !config.legend && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-4 h-4 rounded",
                                                style: {
                                    ...
                                    config.legend && selectedLayers.includes(key) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "ml-7 mt-2 space-y-1",
                                        children: config.legend.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardContent, "TeKw6+/ViQn4tCShS/sDCYbHCTA=", false, function() {
    return [
...
//# sourceMappingURL=src_f0dc4de0._.js.map